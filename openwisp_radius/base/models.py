...
RAD_NAS_TYPES = app_settings.EXTRA_NAS_TYPES + (
    ('Async', _('Async')),
    ('Sync', _('Sync')),
    ('ISDN Sync', _('ISDN Sync')),
    ('ISDN Async V.120', _('ISDN Async V.120')),
    ('ISDN Async V.110', _('ISDN Async V.110')),
    ('Virtual', _('Virtual')),
    ('PIAFS', 'PIAFS'),
    ('HDLC Clear', _('HDLC Clear')),
    ('Channel', _('Channel')),
    ('X.25', 'X.25'),
    ('X.75', 'X.75'),
    ('G.3 Fax', 'G.3 Fax'),
    ('SDSL', _('SDSL - Symmetric DSL')),
    ('ADSL-CAP', 'ADSL-CAP'),
    ('ADSL-DMT', 'ADSL-DMT'),
    ('IDSL', 'IDSL'),
    ('Ethernet', _('Ethernet')),
    ('xDSL', 'xDSL'),
    ('Cable', _('Cable')),
    ('Wireless - Other', _('Wireless - Other')),
    ('IEEE 802.11', _('Wireless - IEEE 802.11')),
    ('Token-Ring', _('Token-Ring')),
    ('FDDI', 'FDDI'),
    ('Wireless - CDMA2000', _('Wireless - CDMA2000')),
    ('Wireless - UMTS', _('Wireless - UMTS')),
    ('Wireless - 1X-EV', _('Wireless - 1X-EV')),
    ('IAPP', 'IAPP'),
    ('FTTP', 'FTTP'),
    ('IEEE 802.16', _('Wireless - IEEE 802.16')),
    ('IEEE 802.20', _('Wireless - IEEE 802.20')),
    ('IEEE 802.22', _('Wireless - IEEE 802.22')),
    ('PPPoA', _('PPPoA - PPP over ATM')),
    ('PPPoEoA', _('PPPoEoA - PPP over Ethernet over ATM')),
    ('PPPoEoE', _('PPPoEoE - PPP over Ethernet over Ethernet')),
    ('PPPoEoVLAN', _('PPPoEoVLAN - PPP over Ethernet over VLAN')),
    ('PPPoEoQinQ', _('PPPoEoQinQ - PPP over Ethernet over IEEE 802.1QinQ')),
    ('xPON', _('xPON - Passive Optical Network')),
    ('Wireless - XGP', _('Wireless - XGP')),
    ('WiMAX', _('WiMAX Pre-Release 8 IWK Function')),
    ('WIMAX-WIFI-IWK', _('WIMAX-WIFI-IWK: WiMAX WIFI Interworking')),
    ('WIMAX-SFF', _('WIMAX-SFF: Signaling Forwarding Function for LTE/3GPP2')),
    ('WIMAX-HA-LMA', _('WIMAX-HA-LMA: WiMAX HA and or LMA function')),
    ('WIMAX-DHCP', _('WIMAX-DHCP: WIMAX DCHP service')),
    ('WIMAX-LBS', _('WIMAX-LBS: WiMAX location based service')),
    ('WIMAX-WVS', _('WIMAX-WVS: WiMAX voice service')),
    ('Other', _('Other')),
)
RADOP_REPLY_TYPES = (('=', '='), (':=', ':='), ('+=', '+='))
